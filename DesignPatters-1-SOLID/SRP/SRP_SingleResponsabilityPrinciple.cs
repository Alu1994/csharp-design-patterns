...
{
    class SRP_SingleResponsabilityPrinciple
    {
        static void MainSRP(string[] args)
        {
            ...
            var filename = @"D:\Projetos\matheus\repositories\study\GitHub\DesignPatternsInCSharp\DesignPatters-1\SRP\DatabaseHelper\journal.txt";
